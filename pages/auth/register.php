                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    <img src="../../assets/img/galeri-foto.png" alt="">
                                    <span class="d-none d-lg-block">Galeri Foto</span>
                                </a>
                            </div><!-- End Logo -->
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    if (isset($_GET['error']) && $_GET['error'] == 'Email Sudah Ada Yang Pakai') { ?>
                                        <div class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                                            <strong><?php echo $_GET['error']; ?></strong>
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                    ...
                                    <form method="POST" action="../../logic/register/save.php" class="row g-3">
                                        <div class="col-12">
